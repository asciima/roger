...
namespace roger {
	...
	*/
	...
	const static wawo::net::socket_cfg client_cfg = wawo::net::socket_cfg(wawo::net::OPTION_NON_BLOCKING, { 1024 * 512,1024 * 512 }, default_keep_alive_vals);
	const static wawo::net::socket_cfg server_cfg = wawo::net::socket_cfg(wawo::net::OPTION_NON_BLOCKING, { 1024 * 512,1024 * 512 }, default_keep_alive_vals);
